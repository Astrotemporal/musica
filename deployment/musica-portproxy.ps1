...
# -- Ports to forward -------------------------------------------------------
$ports = @(
    @{ listen=4533;  connect=4533;  name="Musica Navidrome";    desc="Navidrome music server (via Caddy)" },
    @{ listen=7171;  connect=7171;  name="Musica MusicGrabber"; desc="MusicGrabber download UI (via Caddy)" },
